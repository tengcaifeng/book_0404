...
@section('content')
  ...
  <form action="/admin/service/product/add" method="post" class="form form-horizontal" id="form-product-add">
  {{ csrf_field() }}
  <div class="row cl">
  ...
  <div class="row cl">
    <label class="form-label col-2"></span>简介：</label>
    <div class="formControls col-5">
      ...
      $('#form-product-add').ajaxSubmit({
          ...
          data: {
           ...
           // price: $('input[name=price]').val(),
            ...
            //content:  ue.getContent() != '' ? '没有内容':  ue.getContent(),
